# -*- coding: utf-8 -*-
# code refer to: https://github.com/huggingface/transformers/blob/main/src/transformers/models/bert/modeling_bert.py
# and https://github.com/liuwei1206/LEBERT/blob/main/wcbert_modeling.py
# was finally modified by Yiwen Jiang @Winning Health Group

import torch
from torch import nn
from transformers.models.bert.modeling_bert import BertAttention, BertIntermediate, BertOutput, load_tf_weights_in_bert
...
class BertAdapterModel(BertPreTrainedModel):
    def __init__(self, config, pretrained_embeddings):
        ...
        self.extra_word_embeddings = nn.Embedding(word_vocab_size, embed_dim)
        ...
        # init the embedding
        self.extra_word_embeddings.weight.data.copy_(torch.from_numpy(pretrained_embeddings))
    ...
    def forward(
        ...
        matched_word_embeddings = self.extra_word_embeddings(matched_word_ids)
        outputs = self.bert(
                input_ids=input_ids,
